...
public class StoryLibrary {
    ...
    private static StoryLibrary ourInstance;
    private static Context sContext;

    private StoryLibrary(Context context) {
...
//        mStories.add(nizarios);
        ...
        DataCenter.getDatacenter(sContext);
        setStories();
    }
    ...
    public static StoryLibrary getInstance(Context context) {
        if(ourInstance == null)
            ourInstance = new StoryLibrary(context);
        return ourInstance;
    }

    public void setStories() {
        mStories = DataCenter.getStories();
    }
